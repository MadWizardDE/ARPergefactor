...
- Support for virtual machines
    ...
    - Traditional WakeOnLAN packets will also be redirected to the physical host
...
But if you just have two devices, for example a laptop and a server to which want to connect, you can also run ARPergefactor right there on your client and configure it to only react to connection attempty made by the very same device.
...
- .NET 9 Runtime (optional, can also deployed as a single executable)
